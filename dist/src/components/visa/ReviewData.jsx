...
const DataRow = ({ label, value }) => (<div className="flex flex-col sm:flex-row py-2 border-b">
...
const ReviewData = () => {
    ...
    return (<div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <DataRow label="Email Address" value={values.email}/>
        ...
        <DataRow label="Date of Birth" value={`${values.dateOfBirth.day}/${values.dateOfBirth.month}/${values.dateOfBirth.year}`}/>
